...
$query = 'SELECT datetime, ROUND(AVG(rating),1) as averageRating FROM post_rating WHERE timestamp > DateADD(mi, -75, CURRENT_TIMESTAMP) AND timestamp < DateADD(mi, -60, CURRENT_TIMESTAMP) AND postid='.$postid;
